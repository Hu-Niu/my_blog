    ...
    <div class="special-sort-container">
        ...
        <el-dialog :title="isUpdate ? '编辑':'增加'" :visible.sync="dialogFormVisible">
            <el-form :model="form">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="专题分类名" label-width="120px" prop="specialSortName">
                            <el-input v-model="form.specialSortName" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
export default {
    ...
    methods: {
        ...
        async deleteConfirmHandle() {
            let {data} = await specialSortApi.deleteSpecialSortByUid(this.selectIds)
            if (data.code === 1) {
                this.$message({
                    message: '删除成功',
                    type: 'success',
        ...
        async getList() {
            let {data} = await specialSortApi.querySpecialSortPage(this.searchParam)
